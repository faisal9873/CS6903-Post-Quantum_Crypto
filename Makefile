...
${LIBDIR}/${KATDIR}/${KATFILE}:
	@mkdir -p ${LIBDIR}/${KATDIR}
	@make -C ${KATDIR}
	@cp ${KATDIR}/${LIBDIR}/${KATFILE} ${LIBDIR}/${KATDIR}/${KATFILE}

kat_deps:
	@cp ${KATDIR}/*.h ${KATDIR}/**/*.h ${INCLUDEDIR}/

kat_chat_Alice: ${LIBDIR}/${KATDIR}/${KATFILE} kat_deps ${APP_HEADERS} ${APP_SOURCES} chat_Alice.c server.c server.h
	$(CC) -o $@ -I${INCLUDEDIR} -L${LIBDIR} ${CFLAGS} -lmceliece 
